...
# Austin ZORI for the Austin tab. Exact match: Austin, MN also exists and has
# NA values in the early years, which is what made the raw line look broken.
